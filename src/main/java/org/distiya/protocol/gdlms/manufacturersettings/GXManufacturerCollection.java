            ...
            if (event == XMLStreamConstants.START_ELEMENT) {
                ...
                if (target.equalsIgnoreCase("Identification")) {
                    ...
                    man.setInactivityMode(
                            org.distiya.protocol.gdlms.manufacturersettings.InactivityMode
                                    .valueOf(data.toUpperCase()));
                } else if (target.equalsIgnoreCase("Type")) {
                    if (authentication != null) {
                        authentication.setType(org.distiya.protocol.gdlms.enums.Authentication
                                .valueOfString(data.toUpperCase()));
                    } else {
                        if (data.equals("BinaryCodedDesimal")) {
                            att.setType(org.distiya.protocol.gdlms.enums.DataType.BCD);
                        } else if (data.equals("OctetString")) {
                            att.setType(org.distiya.protocol.gdlms.enums.DataType.OCTET_STRING);
                        } else {
                            att.setType(org.distiya.protocol.gdlms.enums.DataType
                                    .valueOf(data.toUpperCase()));
                        }
                    }
                    ...
                    if (data.equals("BinaryCodedDesimal")) {
                        ...
                        att.setUIType(org.distiya.protocol.gdlms.enums.DataType
                                .valueOf(data.toUpperCase()));
                    }
                } else if (target.equalsIgnoreCase("GXAuthentication")) {
                    authentication = null;
