...
import org.distiya.protocol.gdlms.secure.AesGcmParameter;
import org.distiya.protocol.gdlms.secure.CountType;
import org.distiya.protocol.gdlms.secure.GXCiphering;
...
abstract class GXDLMS {
    ...
    private static byte[] cipher1(final GXDLMSLNParameters p, final byte[] data)
        ...
        reply.setUInt8(sc);
        // Add IC.
        reply.setUInt32(c.getInvocationCounter());
        reply.set(tmp);
        return reply.array();
    }
