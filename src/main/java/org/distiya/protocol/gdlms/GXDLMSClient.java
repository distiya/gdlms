...
import org.distiya.protocol.gdlms.internal.GXCommon;
import org.distiya.protocol.gdlms.internal.GXDataInfo;
import org.distiya.protocol.gdlms.manufacturersettings.GXObisCodeCollection;
import org.distiya.protocol.gdlms.objects.*;
import org.distiya.protocol.gdlms.secure.GXSecure;
...
public class GXDLMSClient {
     ...
     */
    public void setDateTimeSkips(final Set<DateTimeSkips> value) {
     ...
     */
    public final void
            setProposedConformance(final Set<Conformance> value) {
     ...
     * @return Acknowledgment message as byte array.
     */
    public final byte[] receiverReady(final Set<RequestTypes> type) {
        return GXDLMS.receiverReady(settings, type);
    }
     ...
     *         {@link accessRequest}
     */
    public final List<Entry<Object, ErrorCode>> parseAccessResponse(
        ...
        List<Entry<Object, ErrorCode>> reply =
                new ArrayList<Entry<Object, ErrorCode>>(cnt);
