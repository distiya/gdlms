...
import org.distiya.protocol.gdlms.objects.enums.ApplicationContextName;
import org.distiya.protocol.gdlms.objects.enums.AssociationStatus;
...
/**
 * Online help: <br>
 * https://www.gurux.fi/org.distiya.protocol.gdlms.Objects.GXDLMSAssociationLogicalName
 */
    ...
    static void updateObjectList(final GXDLMSSettings settings,
        ...
        if (value != null) {
            for (Object tmp : (List<?>) value) {
                ...
                if (obj == null) {
                    obj = org.distiya.protocol.gdlms.GXDLMSClient.createObject(type);
