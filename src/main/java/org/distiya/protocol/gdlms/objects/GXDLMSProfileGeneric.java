...
import org.distiya.protocol.gdlms.objects.enums.SortMethod;
...
/**
 * Online help: <br>
 * https://www.gurux.fi/org.distiya.protocol.gdlms.Objects.GXDLMSProfileGeneric
 */
        ...
        if (e.getIndex() == 1) {
            ...
            if (e.getValue() == null) {
                ...
                if (type == ObjectType.NONE) {
                    ...
                    if (sortObject == null) {
                        sortObject = org.distiya.protocol.gdlms.GXDLMSClient.createObject(type);
