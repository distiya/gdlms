...
import org.distiya.protocol.gdlms.objects.enums.MBusEncryptionKeyStatus;
...
/**
 * Online help: <br>
 * https://www.gurux.fi/org.distiya.protocol.gdlms.Objects.GXDLMSMBusClient
 */
public class GXDLMSMBusClient extends GXDLMSObject implements IGXDLMSBase {
    ...
    private List<Entry<String, String>> captureDefinition;
    ...
    public GXDLMSMBusClient(final String ln, final int sn) {
        ...
        captureDefinition =
                new java.util.ArrayList<Entry<String, String>>();
        setVersion(1);
    }
    ...
    public final List<Entry<String, String>>
