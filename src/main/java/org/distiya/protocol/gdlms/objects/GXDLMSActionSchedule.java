...
import org.distiya.protocol.gdlms.objects.enums.SingleActionScheduleType;
...
/**
 * Online help: <br>
 * https://www.gurux.fi/org.distiya.protocol.gdlms.Objects.GXDLMSActionSchedule
 */
    ...
    public final void setValue(final GXDLMSSettings settings,
        ...
        if (e.getIndex() == 1) {
            ...
            if (e.getValue() != null) {
                ...
                ArrayList<GXDateTime> items =
                        new ArrayList<GXDateTime>();
