...
import org.distiya.protocol.gdlms.objects.enums.Weekdays;
...
/**
 * Online help: <br>
 * https://www.gurux.fi/org.distiya.protocol.gdlms.Objects.GXDLMSSchedule
 */
public class GXDLMSSchedule extends GXDLMSObject implements IGXDLMSBase {
    ...
    public final byte[] invoke(final GXDLMSSettings settings,
        ...
        case 1: {
            enableDisable((ArrayList<?>) e.getParameters());
        }
            break;
        // Insert entry
        case 2:
            ...
            GXDLMSScheduleEntry entry = createEntry(settings,
                    (ArrayList<?>) e.getParameters(), useUtc);
